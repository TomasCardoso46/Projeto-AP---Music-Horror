...
/// <summary>
/// Sound broadcaster. Attach to any object that can make a sound heard by the enemy.
/// Call PlaySound() to broadcast a sound event to any enemies.
/// </summary>
public class SoundEmitter : MonoBehaviour
{
    ...
    //enemies subscribe to this to react to sounds.
